  ...
  <div class="site-section">
    <div class="container">
      <div class="row block-9">
        <div class="col-md-6 pr-md-5">
          <form action="{{route('contact.store')}}" method="POST" enctype="multipart/form-data" required>
            ...
            <div class="form-group">
              ...
              <textarea name="message" id="" cols="30" rows="7" class="form-control px-3 py-3" placeholder="Type Your Message Here..." required></textarea>
            </div>
            <div class="form-group">
        ...
        <div class="col-md-6">
            <img src="images/vv.png" alt="" width="550px" height="450px">
