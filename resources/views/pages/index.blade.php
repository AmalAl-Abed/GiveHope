...
<div class="block-31" style="position: relative;">
    <div class=" loop-block-31 ">
      <div class="block-30 block-30-sm item" style="background-image: url('images/landing.jpg');" data-stellar-background-ratio="0.5">
        <div class="container">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 welcome-text">
          ...
          <p class="mb-0"><a href="/about" class="btn btn-primary px-3 py-2" style="color: black">Read More</a></p>
        </div>
      </div>
    </div>
  </div>
